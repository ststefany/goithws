...
public class CollegeStudent extends Student {
    ...
    public CollegeStudent (String firstName, String lastName, Course[] coursesTaken, int group, String collegeName, int rating, long id ) {
        super (firstName, lastName, coursesTaken, group);
